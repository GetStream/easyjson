# easyjson [![Build Status](https://travis-ci.org/getstream/easyjson.svg?branch=master)](https://travis-ci.org/getstream/easyjson) [![Go Report Card](https://goreportcard.com/badge/github.com/getstream/easyjson)](https://goreportcard.com/report/github.com/getstream/easyjson)
...
```sh
# install
go get -u github.com/getstream/easyjson/...
...
listing](https://godoc.org/github.com/getstream/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/getstream/easyjson/buffer)
